...
<template>
  <div
    class="flex justify-between fixed top-0 left-0 right-0 z-10 h-20 bg-white text-slate-700 dark:text-slate-300 dark:bg-slate-900 shadow dark:shadow-gray-700 flex items-center px-2"
  >
    ...
    <div class="ml-2 flex items-center">
      ...
      <el-dropdown>
        <div class="flex justify-center items-center h-full w-full">
          ...
          >
            <CustomPic />
            <span v-show="!isMobile" class="w-36">{{ userStore.userInfo.nickname }}</span>
            <el-icon>
              <arrow-down />
            </el-icon>
          </span>
