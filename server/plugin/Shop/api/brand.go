...
func (self *brand) CreateBrand(c *gin.Context) {
...
func (self *brand) DeleteBrand(c *gin.Context) {
	ID := c.Query("ID")
...
func (self *brand) DeleteBrandByIds(c *gin.Context) {
...
func (self *brand) UpdateBrand(c *gin.Context) {
	var info model.Brand
	err := c.ShouldBindJSON(&info)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
func (self *brand) FindBrand(c *gin.Context) {
	ID := c.Query("ID")
...
func (self *brand) GetBrandList(c *gin.Context) {
...
func (self *brand) GetBrandPublic(c *gin.Context) {
