...
func (s *DictionaryApi) CreateSysDictionary(c *fiber.Ctx) {
	var dictionary system.SysDictionary
	err := c.BodyParser(&dictionary)
	if err != nil {
...
func (s *DictionaryApi) DeleteSysDictionary(c *fiber.Ctx) {
	var dictionary system.SysDictionary
	err := c.BodyParser(&dictionary)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
func (s *DictionaryApi) UpdateSysDictionary(c *fiber.Ctx) {
	var dictionary system.SysDictionary
	err := c.BodyParser(&dictionary)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
func (s *DictionaryApi) FindSysDictionary(c *fiber.Ctx) {
	var dictionary system.SysDictionary
...
func (s *DictionaryApi) GetSysDictionaryList(c *fiber.Ctx) {
