...
func (self *{{.Abbreviation}}) Create{{.StructName}}(c *gin.Context) {
    // 创建业务用Context
	...
	if err != nil {
        global.GVA_LOG.Debug("创建失败!", zap.Error(err))
...
func (self *{{.Abbreviation}}) Delete{{.StructName}}(c *gin.Context) {
    // 创建业务用Context
    ctx := c.Request.Context()
...
{{- end }}
	...
	if err != nil {
        global.GVA_LOG.Debug("删除失败!", zap.Error(err))
...
func (self *{{.Abbreviation}}) Delete{{.StructName}}ByIds(c *gin.Context) {
    // 创建业务用Context
    ctx := c.Request.Context()
...
{{- end }}
	...
	if err != nil {
        global.GVA_LOG.Debug("批量删除失败!", zap.Error(err))
...
func (self *{{.Abbreviation}}) Update{{.StructName}}(c *gin.Context) {
    // 创建业务用Context
    ctx := c.Request.Context()
...
{{- end }}
    ...
    if err != nil {
        global.GVA_LOG.Debug("更新失败!", zap.Error(err))
...
func (self *{{.Abbreviation}}) Find{{.StructName}}(c *gin.Context) {
    // 创建业务用Context
    ctx := c.Request.Context()
	...
	if err != nil {
        global.GVA_LOG.Debug("查询失败!", zap.Error(err))
...
func (a *{{.Abbreviation}}) Get{{.StructName}}List(c *gin.Context) {
	...
	if err != nil {
	    global.GVA_LOG.Debug("获取失败!", zap.Error(err))
...
// @Success 200 {object} response.Response{data=response.PageResult,msg=string} "获取成功"
// @Router /{{.Abbreviation}}/get{{.StructName}}List [get]
func (self *{{.Abbreviation}}) Get{{.StructName}}List(c *gin.Context) {
    // 创建业务用Context
    ctx := c.Request.Context()
...
func (self *{{.Abbreviation}}) Get{{.StructName}}DataSource(c *gin.Context) {
    // 创建业务用Context
    ctx := c.Request.Context()
...
func (self *{{.Abbreviation}}) Get{{.StructName}}Public(c *gin.Context) {
    // 创建业务用Context
    ctx := c.Request.Context()
